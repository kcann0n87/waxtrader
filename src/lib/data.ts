...
export const skus: Sku[] = [
  ...
  {
    id: "26",
    slug: "2024-panini-contenders-football-hobby-box",
    year: 2024,
    brand: "Panini",
    sport: "NFL",
    set: "Contenders",
    ...
    description: "2024 Panini Contenders Football Hobby Box. 5 autos per box including on-card. The hobby's signature rookie auto chase.",
    imageUrl: "/products/2024-panini-contenders-football-hobby-box.jpg",
  },
  {
    id: "27",
